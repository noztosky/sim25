...
IF NOT EXIST %temp%\cmake-3.28.3-windows-x86_64.msi (
	@echo on
	powershell -command "& { iwr https://github.com/Kitware/CMake/releases/download/v3.28.3/cmake-3.28.3-windows-x86_64.msi -OutFile %temp%\cmake-3.28.3-windows-x86_64.msi }"
	@echo off
)

msiexec.exe /i "%temp%\cmake-3.28.3-windows-x86_64.msi"
